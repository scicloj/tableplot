...
(deftest
 ...
 (is
  ((fn*
    [p1__72706#]
    (-> p1__72706# meta :kindly/kind (= :kind/pprint)))
   v7_l111)))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72707#]
    (= (-> p1__72707# plotly/plot :data first :type) "scatter"))
   v22_l191)))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72708#]
    (= (-> p1__72708# plotly/plot :data first :type) "box"))
   v28_l215)))
...
(def
 ...
 (->
  ...
  (tc/group-by [:cyl])
  (tc/aggregate
   {:total-disp (fn* [p1__72710#] (-> p1__72710# :disp tcc/sum))})
  (tc/order-by [:cyl])
  (plotly/layer-line
...
(def
 ...
 (->
  ...
  (tc/group-by [:cyl])
  (tc/aggregate
   {:total-disp (fn* [p1__72712#] (-> p1__72712# :disp tcc/sum))})
...
(deftest
 ...
 (is
  ((fn*
    [p1__72713#]
    (= (-> p1__72713# plotly/plot :data first :type) "bar"))
   v42_l257)))
...
(def
 ...
 (->
  ...
  (tc/group-by [:cyl])
  (tc/aggregate
   {:total-disp (fn* [p1__72714#] (-> p1__72714# :disp tcc/sum))})
...
(deftest
 ...
 (is
  ((fn*
    [p1__72716#]
    (and
     (= (-> p1__72716# plotly/plot :data first :type) "scatter")
     (= (-> p1__72716# plotly/plot :data first :mode) :text)))
   v49_l281)))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72718#]
    (= (-> p1__72718# plotly/plot :data first :type) "heatmap"))
   v56_l312)))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72719#]
    (and
     (= (-> p1__72719# plotly/plot :data first :type) "scatter")
     (= (-> p1__72719# plotly/plot :data first :mode) :lines)))
   v60_l325)))
...
(def
 ...
 (->
  ...
  (tc/select-rows
   (fn* [p1__72720#] (-> p1__72720# :variable (= "unemploy"))))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72721#]
    (= (-> p1__72721# plotly/plot :data first :type) :splom))
   v69_l386)))
...
(def
 ...
 (->
  (rdatasets/ggplot2-economics_long)
  (tc/select-rows
   (fn* [p1__72722#] (-> p1__72722# :variable (= "unemploy"))))
  (plotly/layer-point
   {:=x :date,
    :=y :value,
    :=mark-color "green",
...
(def
 ...
 (->
  (rdatasets/ggplot2-economics_long)
  (tc/select-rows
   (fn* [p1__72723#] (-> p1__72723# :variable (= "unemploy"))))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72724#]
    (=
     (-> p1__72724# :aerial.hanami.templates/defaults :=layers count)
     2))
   v75_l413)))
...
(def
 ...
 (->
  (rdatasets/ggplot2-economics_long)
  (tc/select-rows
   (fn* [p1__72725#] (-> p1__72725# :variable (= "unemploy"))))
  (plotly/base {:=x :date, :=y :value})
  (plotly/layer-point
   {:=mark-color "green",
    :=mark-size 20,
...
(def
 ...
 (->
  (rdatasets/ggplot2-economics_long)
  (tc/select-rows
   (fn* [p1__72726#] (-> p1__72726# :variable (= "unemploy"))))
  (plotly/base {:=x :date, :=y :value})
  (plotly/layer-line {:=mark-color "purple"})
...
(deftest
 ...
 (is
  ((fn*
    [p1__72727#]
    (=
     (-> p1__72727# :aerial.hanami.templates/defaults :=layers count)
     2))
   v81_l451)))
...
(deftest
 ...
 (is
  ((fn*
    ...
    (and
     (=
      (-> p1__72728# :aerial.hanami.templates/defaults :=layers count)
      2)
     (= (-> p1__72728# plotly/plot :data count) 2)))
   v87_l481)))
  ...
  (plotly/update-data
   (fn
    ...
    (->
     ds
     (tc/select-rows
      (fn* [p1__72729#] (-> p1__72729# :$split-name (= :train)))))))
  (plotly/layer-smooth
   {:=model-options regression-tree-options,
    :=name "prediction",
    :=mark-color "purple"})))
...
(deftest
 t106_l603
 (is
  ((fn* [p1__72730#] (= (-> p1__72730# plotly/plot :data count) 6))
   v104_l594)))
...
(deftest
 t112_l632
 (is
  ((fn* [p1__72731#] (= (-> p1__72731# plotly/plot :data count) 4))
   v110_l623)))
...
(def
 ...
 (->
  (rdatasets/ggplot2-economics_long)
  (tc/select-rows
   (fn* [p1__72732#] (-> p1__72732# :variable (= "unemploy"))))
...
(def
 ...
 (->
  (rdatasets/ggplot2-economics_long)
  (tc/select-rows
   (fn* [p1__72733#] (-> p1__72733# :variable (= "unemploy"))))
  (tc/add-column :relative-time "Past")
  (tc/concat
   (tc/dataset
    {:date
  ...
  (tc/add-column
   ...
   (fn*
    [p1__72734#]
    (datetime/long-temporal-field :years (:date p1__72734#))))
  (tc/add-column
   :month
   (fn*
    [p1__72735#]
    (datetime/long-temporal-field :months (:date p1__72735#))))
...
(def
 ...
 (->
  (rdatasets/ggplot2-economics_long)
  (tc/select-rows
   (fn* [p1__72736#] (-> p1__72736# :variable (= "unemploy"))))
  (tc/add-column :relative-time "Past")
  (tc/concat
   (tc/dataset
    {:date
  ...
  (tc/add-column
   ...
   (fn*
    [p1__72737#]
    (datetime/long-temporal-field :years (:date p1__72737#))))
  (tc/add-column
   :month
   (fn*
    [p1__72738#]
    (datetime/long-temporal-field :months (:date p1__72738#))))
  (tc/map-columns :yearmonth [:year :month] (fn [y m] (+ m (* 12 y))))
  (plotly/base {:=x :date, :=y :value})
  (plotly/layer-smooth
   {:=color :relative-time,
...
(deftest
 ...
 (is
  ((fn*
    [p1__72739#]
    (= (-> p1__72739# plotly/plot :data first :type) "bar"))
   v120_l706)))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72740#]
    (= (-> p1__72740# plotly/plot :data first :type) "heatmap"))
   v126_l725)))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72741#]
    (= (-> p1__72741# plotly/plot :data first :type) "scatter"))
   v130_l739)))
...
(deftest
 t139_l761
 (is
  ((fn* [p1__72743#] (= (-> p1__72743# plotly/plot :data count) 3))
   v137_l756)))
...
(deftest
 ...
 (is
  ((fn*
    [p1__72745#]
    (= (-> p1__72745# plotly/plot :data first :type) "surface"))
   v148_l822)))
  ...
  (->
   {:r (->> (repeatedly n (fn* [] (- (rand) 0.5))) (reductions +)),
    ...
    (->>
     ...
     (reductions +)
     (map (fn* [p1__72747#] (rem p1__72747# 360)))),
    :color (range n)}
   tc/dataset
   (plotly/layer-point
    {:=r :r,
